...
use App\Http\Controllers\PDFInscripcionFirmaController;
    ...
    Route::get('ver/vacantes', [SolicitudVacanteController::class, 'verVacantes'])->name('vacantes.ver');
    Route::get('aprobadas', [SolicitudVacanteController::class, 'vacantesAprobadas'])->name('vacantes.aprobadas');
