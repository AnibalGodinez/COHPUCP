...
class ProfileController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:actualizar contraseña perfil', ['only' => ['cambiarContrasenia']]);
    }
    ...
    public function update(ProfileRequest $request)
    {
        ...
        return back()->withStatus(__('El información del perfil se ha actualizado exitosamente'));
    }
