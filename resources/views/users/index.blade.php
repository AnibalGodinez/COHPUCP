            ...
            <div class="col-md-12">
                <div class="card m-7">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header d-flex justify-content-center align-items-center mb-3 py-3" style="background-color: #b1b3b6; border-bottom: 1px solid #7e7979;">
                            <h3 class="card-title"><strong>Gertionar usuarios</strong></h3>
                        </div>
