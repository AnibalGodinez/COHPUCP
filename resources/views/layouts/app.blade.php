    ...
    <body class="white-content {{ $class ?? '' }}">
        ...
        <div class="fixed-plugin">
            <div class="dropdown show-dropdown">
                ...
                <li class="header-title"> Color de fondo de la barra lateral</li>
                ...
                <li class="header-title">¡Gracias por las acciones!</li>
                <li class="button-container text-center">
                    <button id="twitter" class="btn btn-round btn-info"><i class="fab fa-twitter"></i> &middot; 45</button>
                    <button id="facebook" class="btn btn-round btn-info"><i class="fab fa-facebook-f"></i> &middot; 50</button>
                    <br>
                    <br>
                    <a class="github-button" href="https://github.com/creativetimofficial/white-dashboard-laravel" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star ntkme/github-buttons on GitHub">Comenzar</a>
                </li>
                </ul>
            </div>
        </div>
